/*Clases.
Son una forma de organizar y simplificar el funcionamiento del código 
de una aplicación su sintaxis es la siguiente:
    class nombreClase{
...
class Perro extends Animal{ //La clase perro extiende de la clase animal-
    ...
    /*Sobreescritura.
     Permite a las clases hijas hacer una implementación de un método que 
     ha sido dado por una clase padre.
    */
